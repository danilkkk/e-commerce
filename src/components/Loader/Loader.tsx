...
const Loader: React.FC<LoaderProps> = ({ className,  size = 'l', }) => {
    ...
    switch (size) {
        case "s":
            return (
                <svg className={loaderClassName} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
        ...
        case "m":
            return (
                <svg className={loaderClassName} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        case "l":
            return (
                <svg className={loaderClassName} width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
